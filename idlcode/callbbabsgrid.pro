pro callbbabsgrid, SNname, z, referenceepoch, explosiondate, latemjd, latemag
...
earlymjds=fltarr(ceil((dt.mag_array[all6[0]]-explosiondate)/5.0))

for n=0,n_elements(earlymjds)-1 do earlymjds[n]=ceiling(explosiondate+n*((dt.mag_array[all6[0]]-explosiondate)/n_elements(earlymjds)-1) 
...
earlyvmags=earlymjds[0],dt.mag_array[5,all6[0]]],[earlymjds[0], dt.time_array[all6[0]]], earlymjds)
...
;;;;;;;
latemjds=fltarr(11)
for n=0,n_elements(latemjds)-1 do latemjds[n]=round(dt.time_array[all6[n_elements(all6)-1]]+10.0)/10.0)*10+n*10.0
...
;for e=0,n_earlymjds-1 do earlyvmags[e]=interpol([20.0,dt.mag_array[5,all6[0]]],[57510.0,dt.time_array[all6[0]]], earlymjds)
latevmags=interpol([dt.mag_array[5,all6[n_elements(all6)-1]],latemag],[dt.time_array[all6[n_elements(all6)-1]],latemjd], latemjds)
