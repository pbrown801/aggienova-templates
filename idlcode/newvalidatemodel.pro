pro newvalidatemodel

SNlist=['SN2006aj', 'SN2007od', 'SN2008in', 'SN2013by','SN2006at','SN2007pk','SN2012aw']

z=0.02


filter='/Users/pbrown/Desktop/Dropbox/SN/snscripts/filters/LSST/2017-04_approx/LSST_y.dat'


for q=0,n_elements(SNlist)-1 do begin
...
template_mag_array=fltarr(n_epochs-2)
templateabs_mag_array=fltarr(n_epochs-2)
...
;for n=1, 50 do begin
	...
	spectrum=[transpose(spectrumwaverest*(1.0+z)),transpose(scaledspectrumflux)]

	template_mag_array[n-1]=vegaphot(spectrum, filter)
	templateabs_mag_array[n-1]=vegaphot(originalspectrum, filter)

endfor

if q eq 0 then plot, epochlist, template_mag_array, xrange=[-10,300], yrange=[24,14]
cgoplot, epochlist, template_mag_array, color='white'
...
lightcurvefilename='ANT_'+SNname+'_newvalidationplot.eps'
