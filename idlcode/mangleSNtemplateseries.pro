pro mangleSNtemplateseries, SNname, z, referenceepoch, EBVmw, EBVhost, bigmjdarray, bigmagarray, bigmagerrarray, filterarray, templatemjd, templatespectra
...
;;;;;;
	...
	epochdifference=min( abs(templatemjd - bigmjdarray[n] ),closest)

	templatespectrumfile=templatespectra[closest]
