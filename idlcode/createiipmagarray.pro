pro createIIPmagarray, SNname, filterarray, filtermjdarray, filtermagarray, filtermagerrarray, bigmjdarray, bigmagarray, bigmagerrarray, explosiondate, explosiondateerr
...
earlyoffset=filtermagarray[vfilterindex,*]-interpol(earlyvmag, earlyepoch, filtermjdarray[vbandindex,*]-referenceepoch)

earlymjd_array=referenceepoch+earlyepoch[where(earlyepoch+referenceepoch lt filtermjdarray[vbandindex,0])]
earlyvmagarray=earlyoffset[n_elements(earlymjd_array)-1]+earlyvmag[where(earlyepoch+referenceepoch lt filtermjdarray[vbandindex,0])]
earlyvmagerrarray=earlyoffset+earlyvmagerr[where(earlyepoch+referenceepoch lt filtermjdarray[vbandindex,0])]


;plot, earlymjd_array, earlyvmagarray, yrange=[17,13], charsize=2
;window, 1
;oplot, filtermjdarray[vbandindex,*], filtermagarray[vbandindex,*], psym=5
...
for f=0,39 do latevmagarray[f]=f*10.0*0.0098+filtermagarray[vbandindex,where(filtermjdarray[vbandindex,*] eq max(filtermjdarray[vbandindex,*]))]
latevmagerrarray=fltarr(40)
for f=0,39 do latevmagerrarray[f]=0.2

goodv=where(finite(filtermagarray[vbandindex,*]) eq 1)
bigMJDarray=[earlymjd_array, transpose(filtermjdarray[vbandindex,goodv]), latemjdarray ]
...
bigmagarray[vbandindex,*]=[earlyvmagarray, transpose(filtermagarray[vbandindex,goodv]), latevmagarray]
bigmagerrarray[vbandindex,*]=[earlyvmagerrarray, transpose(filtermagerrarray[vbandindex,goodv]), latevmagerrarray]
...
save, filename=SNname+'_filtermags.sav', SNname, filterarray, filtermjdarray, filtermagarray, filtermagerrarray, bigmjdarray, bigmagarray, bigmagerrarray, explosiondate, explosiondateerr
