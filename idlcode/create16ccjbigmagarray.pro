pro create16ccjbigmagarray, SNname, filterarray, filtermjdarray, filtermagarray, filtermagerrarray, bigmjdarray, bigmagarray, bigmagerrarray, explosiondate, explosiondateerr
...
bigMJDarray=[transpose(filtermjdarray[vbandindex,goodv])]
...
bigmagarray[vbandindex,*]=[transpose(filtermagarray[vbandindex,goodv])]
bigmagerrarray[vbandindex,*]=[transpose(filtermagerrarray[vbandindex,goodv])]
...
plot, bigmjdarray, bigmagarray[vbandindex,*], psym=3,charsize=2
