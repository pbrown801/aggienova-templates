pro createbigmagarray, SNname, filterarray, filtermjdarray, filtermagarray, filtermagerrarray, bigmjdarray, bigmagarray, bigmagerrarray, explosiondate, explosiondateerr, lateslope
...
for f=0,39 do latevmagarray[f]=f*10.0*lateslope+filtermagarray[vbandindex,where(filtermjdarray[vbandindex,*] eq max(filtermjdarray[vbandindex,*]))]
