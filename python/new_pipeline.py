...
def check_filter_data(sn_name, template_spectrum, bool_error):
    if not (bool_error):
...
def main():
    ...
    if(not process_uvot):
        ...
        filter_file_list, zeropointlist, pivotlist=check_filter_data(sn_name, template_spectrum, bool_error)
