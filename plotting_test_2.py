...
ax01.legend([p01, p02, p03, p04, p05, p06, p07, p08], [p01.get_label(), p02.get_label(), p03.get_label(), p04.get_label(), p05.get_label(), p06.get_label(), p07.get_label(), p08.get_label()])
